...
<link rel="stylesheet" href="{{url_for('static', filename='css/barrios.css')}}">
...
<form action="/databarrios" method="POST" id="formulario">
<div class="mb-4">
...
<input type="number" class="form-control" name="fecha" placeholder="fecha">
<hr>
<label class="form-label">Valor del servicio:</label>
<input type="number" class="form-control" name="valor6" value="50000" readonly="readonly",placeholder="valor6">
<hr>
<label class="form-label">Hora de ingreso:</label>
<input type="number" class="form-control" name="hora" placeholder="hora" value="<?php date_default_timezone_set('America/Bogota'); echo( date('H:i', time()));?>"> 
<hr>
<label class="form-label">Hora de salida:</label>
<input type="number" class="form-control" name="salida" readonly="readonly" placeholder="salida" value="<?php date_default_timezone_set('America/Bogota'); echo( date('H:i', time()));?>">
<button href="barrios.php" class="btn btn-primary" type="submit" class="btn btn-primary" id="subir">Submit</button>
</form>
</section>
<br>
<script>
...
$consultasql ="SELECT * FROM barrios";
