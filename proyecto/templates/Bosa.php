...
<head>
	...
	<link rel="stylesheet" type="text/css" href="Bosa.css">
	<script type="text/javascript" src=""></script>
	<link rel="stylesheet" href="css/bootstrap.css"> 
	<script src="https://cdn.jsdelivr.net/npm/@popperjs/core@2.11.6/dist/umd/popper.min.js" integrity="sha384-oBqDVmMz9ATKxIep9tiCxS/Z9fNfEXiDAYTujMAeBAsjFuCZSmKbSSUnQlmh/jp3" crossorigin="anonymous"></script>
<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha1/dist/js/bootstrap.min.js" integrity="sha384-mQ93GR66B00ZXjt0YO5KlohRA5SY2XofN4zfuZxLkoj1gXtW8ANNCe9d5Y3eG5eD" crossorigin="anonymous"></script>
<link rel="stylesheet" href="{{url_for('static', filename='css/Bosa.css')}}">
...
<br>
    ...
    <h2>Bienvenido a la sede de Bosa<h2> 
          <h2>Registro<h2> 
            <hr>
        <div class="row">
<div class="col-md-6 offset-md-3 mb-5">
<form action="/databosa" method="POST" id="formulario">
<div class="mb-4">
...
<hr>
<label class="form-label">Fecha del domicilio:</label>
<input type="date" class="form-control" name="fecha" placeholder="fecha">
<hr>
<label class="form-label">Valor del domicilio:</label>
<input type="number" class="form-control" name="valor4" value="50000" readonly="readonly">
<hr>
<label class="form-label">Hora de llegada:</label>
<input type="time" class="form-control" id="hora" name="hora" placeholder="hora"> 
<hr>
<label class="form-label">Hora de salida:</label>
<input type="time" class="form-control" name="salida" readonly="readonly" placeholder="salida">
<button href="Bosa.php" class="btn btn-primary" type="submit" class="btn btn-primary" id="subir">Submit</button>
<script>
